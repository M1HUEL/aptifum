...
const VARIANTS: Array<{
...
}> = [
  {
    ...
    sku: 'FBT-001-DARK',
    barcode: '75010001002',
    attributes: { size: '1kg', roast: 'Dark' },
    purchasePrice: 12.5,
    salePrice: 26,
    stock: 45,
  },
  {
    ...
    sku: 'FBT-001-MED',
    barcode: '75010001003',
    attributes: { size: '1kg', roast: 'Medium' },
    purchasePrice: 12.5,
    salePrice: 26,
    stock: 30,
  },
...
const CUSTOMERS: Array<{
  ...
  {
    code: 'C-001',
    tradeName: 'Cafe Central',
    taxId: '88-120-4455',
    email: 'orders@cafecentral.example',
    phone: '+1 555-0141',
    creditLimit: 5000,
  },
  {
    code: 'C-002',
    tradeName: 'GreenMart Stores',
    taxId: '92-300-7710',
    email: 'purchasing@greenmart.example',
    phone: '+1 555-0139',
    creditLimit: 15000,
  },
  {
    code: 'C-003',
    tradeName: 'OfficeHub LLC',
    taxId: '77-980-2233',
    email: 'buy@officehub.example',
    phone: '+1 555-0122',
    creditLimit: 10000,
  },
  {
    code: 'C-004',
    tradeName: 'Bright School',
    taxId: '84-556-9010',
    email: 'admin@brightschool.example',
    phone: '+1 555-0155',
    creditLimit: 3000,
  },
  {
    code: 'C-005',
    tradeName: 'Corner Grocery',
    taxId: '55-221-8840',
    email: 'mario@cornergrocery.example',
    phone: '+1 555-0118',
    creditLimit: 2000,
  },
  {
    code: 'C-006',
    tradeName: 'Cafe Europa',
    taxId: 'ES-B-12345678',
    email: 'purchasing@cafeeuropa.example',
    phone: '+34 555 01 42',
    creditLimit: 8000,
    currency: 'EUR',
  },
...
const SUPPLIERS: Array<{
  ...
  {
    code: 'S-001',
    tradeName: 'Alpine Roast Imports',
    taxId: '10-550-1200',
    email: 'sales@alpineroast.example',
    phone: '+1 555-0110',
    paymentTerms: 'net30',
  },
  {
    code: 'S-002',
    tradeName: 'Sparkle Home Care',
    taxId: '20-330-7715',
    email: 'b2b@sparkle.example',
    phone: '+1 555-0125',
    paymentTerms: 'net15',
  },
  {
    code: 'S-003',
    tradeName: 'WhiteEdge Paper Co',
    taxId: '30-990-2210',
    email: 'sales@whiteedge.example',
    phone: '+1 555-0130',
    paymentTerms: 'net30',
  },
  {
    code: 'S-004',
    tradeName: 'VoltMax Electrical',
    taxId: '40-115-5520',
    email: 'quotes@voltmax.example',
    phone: '+1 555-0140',
    paymentTerms: 'net45',
  },
  {
    code: 'S-005',
    tradeName: 'Euro Foods GmbH',
    taxId: 'DE-300123456',
    email: 'sales@eurofoods.example',
    phone: '+49 555 011 47',
    paymentTerms: 'net30',
    currency: 'EUR',
  },
...
const EMPLOYEES: Array<{
  ...
  },
  {
    ...
    firstName: 'Carlos',
    lastName: 'Mendez',
    email: 'carlos.mendez@aptifum.dev',
  ...
  },
  {
    ...
    firstName: 'Lucia',
    lastName: 'Fernandez',
    email: 'lucia.fernandez@aptifum.dev',
    position: 'Sales Associate',
    department: 'D-SALES',
    hireDate: '2024-01-10',
    salary: 2400,
...
export async function seedDemo(overrides: DataSourceOverrides = {}): Promise<void> {
  ...
  try {
    ...
    for (const data of WAREHOUSES) {
      ...
      if (!warehouse) {
        warehouse = await warehouseRepo.save(warehouseRepo.create({ tenantId: tenant.id, ...data }));
      }
    ...
    for (const data of DEPARTMENTS) {
      ...
      if (!department) {
        department = await departmentRepo.save(departmentRepo.create({ tenantId: tenant.id, ...data }));
      }
    ...
    console.log(
      `  Product variants: ${VARIANTS.length} (${variantMovementCount === 0 ? 'stock seeded' : 'stock kept'})`,
    );
