...
export class F3Hr1785896523276 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."hr_attendance_status_enum" AS ENUM('present', 'late', 'absent', 'leave')`);
        await queryRunner.query(`CREATE TYPE "public"."hr_leaves_type_enum" AS ENUM('vacation', 'sick', 'personal', 'other')`);
        await queryRunner.query(`CREATE TYPE "public"."hr_leaves_status_enum" AS ENUM('pending', 'approved', 'rejected', 'cancelled')`);
        ...
        await queryRunner.query(`ALTER TABLE "hr_employees" ADD CONSTRAINT "FK_hr_employees_department" FOREIGN KEY ("department_id") REFERENCES "hr_departments"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "hr_attendance" ADD CONSTRAINT "FK_hr_attendance_employee" FOREIGN KEY ("employee_id") REFERENCES "hr_employees"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "hr_leaves" ADD CONSTRAINT "FK_hr_leaves_employee" FOREIGN KEY ("employee_id") REFERENCES "hr_employees"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "hr_payroll_lines" ADD CONSTRAINT "FK_hr_payroll_lines_payroll" FOREIGN KEY ("payroll_id") REFERENCES "hr_payrolls"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "hr_payroll_lines" ADD CONSTRAINT "FK_hr_payroll_lines_employee" FOREIGN KEY ("employee_id") REFERENCES "hr_employees"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "hr_payrolls" ADD CONSTRAINT "FK_hr_payrolls_posted_entry" FOREIGN KEY ("posted_entry_id") REFERENCES "journal_entries"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
