...
export class VariantStock1786800000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "UQ_product_stock_tenant_product_warehouse" ON "product_stock" ("tenant_id", "product_id", "warehouse_id") WHERE "variant_id" IS NULL`);
        await queryRunner.query(`CREATE UNIQUE INDEX "UQ_product_stock_tenant_variant_warehouse" ON "product_stock" ("tenant_id", "product_id", "variant_id", "warehouse_id") WHERE "variant_id" IS NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "product_stock" ADD CONSTRAINT "FK_product_stock_variant" FOREIGN KEY ("variant_id") REFERENCES "product_variants"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "stock_movements" ADD CONSTRAINT "FK_stock_movements_variant" FOREIGN KEY ("variant_id") REFERENCES "product_variants"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "invoice_items" ADD CONSTRAINT "FK_invoice_items_variant" FOREIGN KEY ("variant_id") REFERENCES "product_variants"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "sales_order_items" ADD CONSTRAINT "FK_sales_order_items_variant" FOREIGN KEY ("variant_id") REFERENCES "product_variants"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "product_stock" ADD CONSTRAINT "UQ_af10c750cc260127b5a13176135" UNIQUE ("tenant_id", "product_id", "warehouse_id")`);
