...
export class F3Crm1785895565712 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."crm_opportunities_stage_enum" AS ENUM('prospecting', 'qualification', 'proposal', 'negotiation', 'won', 'lost')`);
        await queryRunner.query(`CREATE TYPE "public"."crm_activities_type_enum" AS ENUM('call', 'meeting', 'task', 'note')`);
        ...
        await queryRunner.query(`ALTER TABLE "crm_contacts" ADD CONSTRAINT "FK_crm_contacts_customer" FOREIGN KEY ("customer_id") REFERENCES "customers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "crm_leads" ADD CONSTRAINT "FK_crm_leads_converted_customer" FOREIGN KEY ("converted_customer_id") REFERENCES "customers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "crm_opportunities" ADD CONSTRAINT "FK_crm_opportunities_customer" FOREIGN KEY ("customer_id") REFERENCES "customers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "crm_opportunities" ADD CONSTRAINT "FK_crm_opportunities_lead" FOREIGN KEY ("lead_id") REFERENCES "crm_leads"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
