...
export class SupplierBills1786500000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "supplier_bills" ADD CONSTRAINT "FK_sb_supplier" FOREIGN KEY ("supplier_id") REFERENCES "suppliers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "supplier_bill_items" ADD CONSTRAINT "FK_sbi_bill" FOREIGN KEY ("bill_id") REFERENCES "supplier_bills"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "supplier_bill_items" ADD CONSTRAINT "FK_sbi_product" FOREIGN KEY ("product_id") REFERENCES "products"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "supplier_payments" ADD CONSTRAINT "FK_sp_bill" FOREIGN KEY ("bill_id") REFERENCES "supplier_bills"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
