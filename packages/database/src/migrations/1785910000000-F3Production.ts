...
export class F3Production1785910000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TYPE "public"."document_series_kind_enum" ADD VALUE IF NOT EXISTS 'production_order'`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."production_orders_status_enum" AS ENUM('planned', 'in_progress', 'completed', 'cancelled')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_production_bom_lines_tenant_id" ON "production_bom_lines" ("tenant_id") `,
    );
    await queryRunner.query(`CREATE INDEX "IDX_production_bom_lines_bom_id" ON "production_bom_lines" ("bom_id") `);
    await queryRunner.query(
      `CREATE INDEX "IDX_production_bom_lines_product_id" ON "production_bom_lines" ("product_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_production_order_lines_tenant_id" ON "production_order_lines" ("tenant_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_production_order_lines_order_id" ON "production_order_lines" ("order_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_production_order_lines_product_id" ON "production_order_lines" ("product_id") `,
    );
    await queryRunner.query(
      `ALTER TABLE "production_boms" ADD CONSTRAINT "FK_production_boms_product" FOREIGN KEY ("product_id") REFERENCES "products"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "production_bom_lines" ADD CONSTRAINT "FK_production_bom_lines_bom" FOREIGN KEY ("bom_id") REFERENCES "production_boms"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "production_bom_lines" ADD CONSTRAINT "FK_production_bom_lines_product" FOREIGN KEY ("product_id") REFERENCES "products"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "production_orders" ADD CONSTRAINT "FK_production_orders_product" FOREIGN KEY ("product_id") REFERENCES "products"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "production_orders" ADD CONSTRAINT "FK_production_orders_bom" FOREIGN KEY ("bom_id") REFERENCES "production_boms"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "production_orders" ADD CONSTRAINT "FK_production_orders_warehouse" FOREIGN KEY ("warehouse_id") REFERENCES "warehouses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "production_order_lines" ADD CONSTRAINT "FK_production_order_lines_order" FOREIGN KEY ("order_id") REFERENCES "production_orders"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "production_order_lines" ADD CONSTRAINT "FK_production_order_lines_product" FOREIGN KEY ("product_id") REFERENCES "products"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
