...
export class F1Sales1785809089855 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."sales_orders_status_enum" AS ENUM('draft', 'confirmed', 'invoiced', 'cancelled')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "sales_order_items" ADD CONSTRAINT "FK_03b37c70136abdfd3841f176cd7" FOREIGN KEY ("order_id") REFERENCES "sales_orders"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "sales_order_items" ADD CONSTRAINT "FK_a26c8d9474f682fcb603797e78d" FOREIGN KEY ("product_id") REFERENCES "products"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "sales_orders" ADD CONSTRAINT "FK_d06febc93fc604568a79b11474d" FOREIGN KEY ("warehouse_id") REFERENCES "warehouses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
