...
export class F1Inventory1785808351615 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."stock_movements_movement_type_enum" AS ENUM('inbound', 'outbound', 'adjustment', 'transfer', 'return', 'disposal')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "warehouse_locations" ADD CONSTRAINT "FK_850b86bd98dd7d3647d6466789f" FOREIGN KEY ("warehouse_id") REFERENCES "warehouses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "product_stock" ADD CONSTRAINT "FK_62a8438c36b1a42790d3cd755a1" FOREIGN KEY ("product_id") REFERENCES "products"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "product_stock" ADD CONSTRAINT "FK_47fdcc7c3925b07f2d3a53cd9de" FOREIGN KEY ("warehouse_id") REFERENCES "warehouses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
