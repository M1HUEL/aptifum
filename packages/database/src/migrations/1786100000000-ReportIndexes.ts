...
export class ReportIndexes1786100000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE INDEX "IDX_invoices_tenant_status_issue_date" ON "invoices" ("tenant_id", "status", "issue_date") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_purchase_order_items_product_id" ON "purchase_order_items" ("product_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_goods_receipt_items_product_id" ON "goods_receipt_items" ("product_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_products_category_id" ON "products" ("category_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_stock_movements_tenant_occurred_at" ON "stock_movements" ("tenant_id", "occurred_at") `);
        await queryRunner.query(`CREATE INDEX "IDX_journal_entries_period_id" ON "journal_entries" ("period_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_journal_entries_tenant_entry_date" ON "journal_entries" ("tenant_id", "entry_date") `);
        await queryRunner.query(`CREATE INDEX "IDX_purchase_orders_tenant_status" ON "purchase_orders" ("tenant_id", "status") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_audit_logs_tenant_created_at" ON "audit_logs" ("tenant_id", "created_at") `);
