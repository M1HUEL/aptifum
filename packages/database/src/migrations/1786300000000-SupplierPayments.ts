...
export class SupplierPayments1786300000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."supplier_payments_method_enum" AS ENUM('cash', 'card', 'transfer', 'other')`);
        ...
        await queryRunner.query(`ALTER TABLE "supplier_payments" ADD CONSTRAINT "FK_sp_supplier" FOREIGN KEY ("supplier_id") REFERENCES "suppliers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
